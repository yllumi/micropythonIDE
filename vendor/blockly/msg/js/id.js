...
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "dari %1 ke %2 setiap %3 langkah";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST = "Set item pertama di dalam list.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_END = "Set item ke dalam posisi yang telah ditentukan di dalam list. #1 adalah item yang terakhir.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_START = "Set item ke dalam posisi yang telah ditentukan di dalam list. #1 adalah item yang pertama.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST = "Menetapkan item terakhir dalam list.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM = "Set secara acak sebuah item dalam list.";
...
Blockly.Msg.LOGIC_NEGATE_TITLE = "negasi %1";
...
Blockly.Msg.VARIABLES_SET_TAIL = "dengan nilai";
Blockly.Msg.VARIABLES_SET_TITLE = "Set";
Blockly.Msg.VARIABLES_SET_TOOLTIP = "Set variabel ini dengan input yang sama.";
