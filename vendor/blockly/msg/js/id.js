...
Blockly.Msg.AUTH = "Silakan autorisasi aplikasi ini untuk mengaktifkan pekerjaan Anda agar dapat disimpan dan dibagikan.";
Blockly.Msg.CHANGE_VALUE_TITLE = "Ubah nilai:";
Blockly.Msg.CHAT = "Diskusi bersama kolaborator melalui kotak ini!";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP = "Buatlah warna dengan jumlah yang ditentukan dari merah, hijau dan biru. Semua nilai harus berkisar antara 0 sampai 100.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL = "https://github.com/google/blockly/wiki/Loops#loop-termination-blocks"; 
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "Keluar dari perulangan";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "Lanjutkan dengan langkah pengulangan berikutnya";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "Keluar sementara dari perulanggan.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Abaikan sisa dari perulangan ini, dan lanjutkan dengan iterasi berikutnya.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "Untuk setiap item di dalam list, tetapkan variabel '%1' ke dalam item, selanjutnya kerjakan beberapa pernyataan.";
Blockly.Msg.CONTROLS_FOR_HELPURL = "https://github.com/google/blockly/wiki/Loops#count-with";
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "setiap %3 langkah, dari %1 sampai %2";
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = "Cacah";
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "Menggunakan variabel %1 dengan mengambil nilai dari batas awal hingga ke batas akhir, dengan interval tertentu, dan mengerjakan blok tertentu.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "tambahkan prasyarat ke dalam blok IF.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Terakhir, tambahkan tangkap-semua kondisi kedalam blok 'jika'.";
Blockly.Msg.CONTROLS_IF_HELPURL = "https://github.com/google/blockly/wiki/IfElse";
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Menambahkan, menghapus, atau menyusun kembali bagian untuk mengkonfigurasi blok 'jika' ini.";
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "selain itu";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "ulangi hingga";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_END = "Sisipkan item ke dalam posisi yang telah ditentukan didalam list. Item pertama adalah item yang terakhir.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_START = "Sisipkan item ke dalam posisi yang telah ditentukan didalam list. Item pertama adalah item terakhir (yg paling akhir).";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST = "Mengembalikan item pertama dalam list.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM = "Mengembalikan item acak dalam list.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST = "Menghilangkan dan mengembalikan item pertama dalam list.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_END = "Menghilangkan dan mengembalikan barang di posisi tertentu dalam list.  #1 adalah item terakhir.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_START = "Menghilangkan dan mengembalikan barang di posisi tertentu dalam list.  #1 adalah item pertama.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST = "Menghilangkan dan mengembalikan item terakhir dalam list.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM = "Menghilangkan dan mengembalikan barang dengan acak dalam list.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST = "Menghapus item pertama dalam list.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_END = "Menghapus item dengan posisi tertentu dalam list. Item pertama adalah item yang terakhir.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_START = "Menghapus item dengan posisi tertentu dalam list. Item pertama adalah item yang terakhir.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP = "Mengembalikan indeks dari kejadian pertama/terakhir item dalam list.  Menghasilkan 0 jika teks tidak ditemukan.";
...
Blockly.Msg.LISTS_REPEAT_TITLE = "membuat list dengan item %1 diulang %2 kali";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN = "Menggabungkan list teks ke dalam satu baris teks, dipisahkan oleh pembatas.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT = "Pecah teks ke dalam bentuk list berdasarkan pembatas.";
...
Blockly.Msg.LOGIC_NEGATE_TITLE = "tidak %1";
...
Blockly.Msg.LOGIC_TERNARY_CONDITION = "tes";
...
Blockly.Msg.MATH_CHANGE_INPUT_BY = "menjadi";
Blockly.Msg.MATH_CHANGE_TITLE_CHANGE = "ubah nilai";
...
Blockly.Msg.MATH_IS_DIVISIBLE_BY = "habis dibagi oleh";
...
Blockly.Msg.MATH_ONLIST_OPERATOR_SUM = "total dari list";
...
Blockly.Msg.MATH_ROUND_OPERATOR_ROUNDDOWN = "bulatkan ke bawah";
Blockly.Msg.MATH_ROUND_OPERATOR_ROUNDUP = "bulatkan ke atas";
...
Blockly.Msg.PROCEDURES_DEFRETURN_RETURN = "kembalikan";
...
Blockly.Msg.PROCEDURES_MUTATORARG_TOOLTIP = "Tambah masukan ke dalam fungsi.";
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TITLE = "input";
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP = "Tambah, hapus, atau urut ulang masukan ke fungsi ini.";
